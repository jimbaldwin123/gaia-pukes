...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000007805dd7d00000004a91e885b(
...
class phpbbtemplatetwiglexer_000000007805dd7d00000004a91e885b extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5db6723664f7a613614327 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5db6723664f8f651344484 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5db6723664f3f508619385 = array(
    ...
    {
        $this->initializer5db6723664f8f651344484 && ($this->initializer5db6723664f8f651344484->__invoke($valueHolder5db6723664f7a613614327, $this, 'set_environment', array('env' => $env), $this->initializer5db6723664f8f651344484) || 1) && $this->valueHolder5db6723664f7a613614327 = $valueHolder5db6723664f7a613614327;

        return $this->valueHolder5db6723664f7a613614327->set_environment($env);
    }
    ...
    {
        $this->initializer5db6723664f8f651344484 && ($this->initializer5db6723664f8f651344484->__invoke($valueHolder5db6723664f7a613614327, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5db6723664f8f651344484) || 1) && $this->valueHolder5db6723664f7a613614327 = $valueHolder5db6723664f7a613614327;

        return $this->valueHolder5db6723664f7a613614327->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5db6723664f8f651344484 && ($this->initializer5db6723664f8f651344484->__invoke($valueHolder5db6723664f7a613614327, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5db6723664f8f651344484) || 1) && $this->valueHolder5db6723664f7a613614327 = $valueHolder5db6723664f7a613614327;

        return $this->valueHolder5db6723664f7a613614327->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5db6723664f8f651344484 = $initializer;
    }
    ...
    {
        $this->initializer5db6723664f8f651344484 && ($this->initializer5db6723664f8f651344484->__invoke($valueHolder5db6723664f7a613614327, $this, '__get', array('name' => $name), $this->initializer5db6723664f8f651344484) || 1) && $this->valueHolder5db6723664f7a613614327 = $valueHolder5db6723664f7a613614327;

        if (isset(self::$publicProperties5db6723664f3f508619385[$name])) {
            return $this->valueHolder5db6723664f7a613614327->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5db6723664f7a613614327;
    ...
    {
        $this->initializer5db6723664f8f651344484 && ($this->initializer5db6723664f8f651344484->__invoke($valueHolder5db6723664f7a613614327, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5db6723664f8f651344484) || 1) && $this->valueHolder5db6723664f7a613614327 = $valueHolder5db6723664f7a613614327;
    ...
    {
        $this->initializer5db6723664f8f651344484 && ($this->initializer5db6723664f8f651344484->__invoke($valueHolder5db6723664f7a613614327, $this, '__isset', array('name' => $name), $this->initializer5db6723664f8f651344484) || 1) && $this->valueHolder5db6723664f7a613614327 = $valueHolder5db6723664f7a613614327;
    ...
    {
        $this->initializer5db6723664f8f651344484 && ($this->initializer5db6723664f8f651344484->__invoke($valueHolder5db6723664f7a613614327, $this, '__unset', array('name' => $name), $this->initializer5db6723664f8f651344484) || 1) && $this->valueHolder5db6723664f7a613614327 = $valueHolder5db6723664f7a613614327;
    ...
    {
        $this->initializer5db6723664f8f651344484 && ($this->initializer5db6723664f8f651344484->__invoke($valueHolder5db6723664f7a613614327, $this, '__clone', array(), $this->initializer5db6723664f8f651344484) || 1) && $this->valueHolder5db6723664f7a613614327 = $valueHolder5db6723664f7a613614327;

        $this->valueHolder5db6723664f7a613614327 = clone $this->valueHolder5db6723664f7a613614327;
    }

    public function __sleep()
    {
        $this->initializer5db6723664f8f651344484 && ($this->initializer5db6723664f8f651344484->__invoke($valueHolder5db6723664f7a613614327, $this, '__sleep', array(), $this->initializer5db6723664f8f651344484) || 1) && $this->valueHolder5db6723664f7a613614327 = $valueHolder5db6723664f7a613614327;

        return array('valueHolder5db6723664f7a613614327');
    }
    ...
    {
        return $this->initializer5db6723664f8f651344484;
    }
    ...
    {
        return $this->initializer5db6723664f8f651344484 && ($this->initializer5db6723664f8f651344484->__invoke($valueHolder5db6723664f7a613614327, $this, 'initializeProxy', array(), $this->initializer5db6723664f8f651344484) || 1) && $this->valueHolder5db6723664f7a613614327 = $valueHolder5db6723664f7a613614327;
    }
    ...
    {
        return null !== $this->valueHolder5db6723664f7a613614327;
    }
    ...
    {
        return $this->valueHolder5db6723664f7a613614327;
    }
